...
class VOD:
    ...
    def playAsset(self, asset_id, infolabels=None, art=None, parental_rating=0):
        ...
        if len(asset_info) > 0:
            ...
            self.skygo.play(manifest_url, package_code=asset_info['package_code'], parental_rating=parental_rating, info_tag=infolabels, art_tag=art, apix_id=str(asset_info['event_id']))
        else:
