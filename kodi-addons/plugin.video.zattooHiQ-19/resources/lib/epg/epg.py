...
from resources.lib.epg.strings import *
...
class EPG(xbmcgui.WindowXML):
    ...
    def __new__(cls, currentNr, premiumUser):
       ...
       if __addon__.getSetting('livetv') == "true":
           return super(EPG, cls).__new__(cls, 'script-tvguide-main-livetv.xml', ADDON.getAddonInfo('path') + '/resources/lib/epg')
       else:
           return super(EPG, cls).__new__(cls, 'script-tvguide-main.xml', ADDON.getAddonInfo('path') + '/resources/lib/epg')
